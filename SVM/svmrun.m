...
while tcurr<=tend
    ...
    [vhpl, usr2satdata, Uire, usrdata] = usrprocess(satdata, usrdata, igpdata, ...
                               ...
                               rss_udre, rss_iono);
    iono_mean_enu(:, :, itstep) = usrdata(:, COL_USR_BIASUIRE_ENU);
    iono_sig2_enu(:, :, itstep) = usrdata(:, COL_USR_SIG2UIRE_ENU);
...
save 'outputs' satdata usrdata wrsdata igpdata inv_igp_mask sat_xyz udrei ...
               ...
               Uire avg_iono_mean_enu avg_iono_sig2_enu;
% OUTPUT processing
outputprocess(satdata,usrdata,wrsdata,igpdata,inv_igp_mask,sat_xyz,udrei,...
              ...
              avg_iono_mean_enu, avg_iono_sig2_enu);
