function [mu_uire, sig2_uire, Uire, usrdata] = af_nse_uire(usrdata, usr2satdata, good_los)
...
global COL_U2S_UID COL_U2S_EL COL_U2S_GENUB COL_U2S_BIASUIRE_ENU COL_U2S_SIG2UIRE_ENU
...
usr2satdata(:, COL_U2S_BIASUIRE_ENU) = usr2satdata(:, COL_U2S_GENUB(1:3)) .* mu_uire;
usr2satdata(:, COL_U2S_SIG2UIRE_ENU) = usr2satdata(:, COL_U2S_GENUB(1:3)) .* sig2_uire;
