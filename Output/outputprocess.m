function outputprocess(usrdata,igpdata,inv_igp_mask,...
                       givei,...
					   outputs,percent,...
					   IonoError, iono_mean_enub, iono_sig_enub,...
